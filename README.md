...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="output.gif?v=643ccfab">
  <source media="(prefers-color-scheme: light)" srcset="output.gif?v=643ccfab">
  <img alt="Animated GitHub profile terminal" src="output.gif?v=643ccfab" width="100%">
</picture>
